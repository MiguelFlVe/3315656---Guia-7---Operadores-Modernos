...
//Ejercico 4: Mezcla de configuraciones con spread y destructuración
import { configurarUsuario, defaults } from "./configurarUsuario.js";
...
const Aprop = {
  ...
  Ej4: "Mezcla de configuraciones con spread y destructuración",
...
while (condition) {
  const { Ej1, Ej2, Ej3, Ej4, Ej7, Ej8 } = Aprop;
